    ...
    <div className="px-6 py-4 mt-10 flex justify-center gap-6 items-center flex-col lg:flex-row ">
      ...
      <div className="flex flex-col justify-center lg:justify-start lg:items-start items-center gap-3 w-full lg:w-[40vw]">
        ...
        <input
          ...
          className="w-100 px-5 py-2 border border-gray-200 rounded-full"
        />
        <button className="tranistion-all hover:bg-blue-900      bg-blue-800 text-white rounded-full py-2  w-100">
          Sign up free &#8594;
        </button>
        <p className="text-xs text-gray-600">
          Collaorate with your team within minutes
        </p>
        <div className="w-100 flex px-3 justify-between items-center bg-slate-200 py-3">
